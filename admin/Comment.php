...
?>
	...
	<head>
		<title>Trang tổng quan - Nhận xét</title>
	...
	<body>
		...
		<div class="main-table">
			<h3 class="mb-3">Tất cả bình luận</h3>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<a href="comment-delete.php?comment_id=<?= $comment['comment_id'] ?>" class="btn btn-danger">Xóa bỏ</a>
								</td>
							</tr>
						<?php } ?>
